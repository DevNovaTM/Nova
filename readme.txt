Nova - Readme (And OpenSSl !!!!)

------------------------------------
1. Nova information
2. OpenSSL information
------------------------------------
[GitHub: https://github.com/DevNovaTM/Nova]
Всем салам, это нова, короче говоря мини инди хуйня проект по типу Session(GetSession.org).
Скажу вам так, цели сделать чтото ахуенное у меня нет, это скорее лишь тест 

Дата начала - февраль 2025
Дата написания этого ридми - 23.02.2025 

Создатель - Westttik 

Шифрование и TLS было сделано с помощью OpenSSl, вся инфа ниже. 


Права все сохранены, лицензия есть, Сертифекат OpenSSl тоже 
[GitHub: https://github.com/DevNovaTM/Nova]
-------------------------------------------------------------------------------------------------
OpenSSl information :
-------------------------------------------------------------------------------------------------
